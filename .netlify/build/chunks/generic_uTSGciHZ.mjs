import { A as AstroError, f as NoImageMetadata, F as FailedToFetchRemoteImageDimensions, E as ExpectedImageOptions, g as ExpectedImage, h as ExpectedNotESMImage, r as resolveSrc, i as isRemoteImage, j as isESMImportedImage, k as isLocalService, D as DEFAULT_HASH_PROPS, l as InvalidImageService, m as ImageMissingAlt, n as AstroError$1, o as InvalidImageService$1, p as isRemoteAllowed } from './astro/assets-service_B9R_EjtW.mjs';
import { isRemotePath } from '@astrojs/internal-helpers/path';
import { c as createComponent, r as renderTemplate, m as maybeRenderHead, a as addAttribute, s as spreadAttributes, b as createAstro } from './astro/server_CHkuB5dE.mjs';
import 'html-escaper';
import 'clsx';
...
async function getConfiguredImageService$1() {
  if (!globalThis?.astroAsset?.imageService) {
    const { default: service } = await import(
      // @ts-expect-error
      './astro/assets-service_B9R_EjtW.mjs'
    ).then(n => n.s).catch((e) => {
...
}, "C:/web-projects/qr-coming-soon/node_modules/astro/components/Image.astro", void 0);
...
}, "C:/web-projects/qr-coming-soon/node_modules/astro/components/Picture.astro", void 0);
